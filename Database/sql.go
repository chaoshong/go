...
func Init() {
	...
	Db.AutoMigrate(&models.Stock{}, &models.Employee{}, &models.OrderBalance{}, &models.OrderLittleBoss{}, &models.OrderIsale{}, &models.PostFee{}, &models.PostZone{}, &models.ProductCommon{})
